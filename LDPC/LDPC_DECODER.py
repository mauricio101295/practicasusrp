...
class LDPC_DECODER(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, frame_size=42, puncpat='11'):
        ...
        labels = ['Señal Original ', 'Señal codificada LDPC', 'Señal LDPC', 'CC (K=7, Rate=2)', 'CCSDS',
        ...
        self.pdu_tagged_stream_to_pdu_1 = pdu.tagged_stream_to_pdu(gr.types.float_t, 'size')
        self.pdu_tagged_stream_to_pdu_0 = pdu.tagged_stream_to_pdu(gr.types.byte_t, 'size')
        self.pdu_pdu_to_tagged_stream_0_0 = pdu.pdu_to_tagged_stream(gr.types.byte_t, 'size')
        self.pdu_pdu_to_tagged_stream_0 = pdu.pdu_to_tagged_stream(gr.types.byte_t, 'size')
        self.fec_async_encoder_0 = fec.async_encoder(ldpc_enc, False, True, True, MTU)
        self.fec_async_decoder_0 = fec.async_decoder(ldpc_dec, False, True, MTU)
        self.digital_map_bb_0 = digital.map_bb([-1,1])
        self.blocks_vector_source_x_0_1_0 = blocks.vector_source_b((frame_size//15)*[0, 1,1], True, 1, [])
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_char*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_stream_to_tagged_stream_0_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, frame_size, 'size')
        self.blocks_repack_bits_bb_0_0 = blocks.repack_bits_bb(8, 1, 'size', False, gr.GR_LSB_FIRST)
    ...
    def set_frame_size(self, frame_size):
        ...
        self.blocks_vector_source_x_0_1_0.set_data((self.frame_size//15)*[0, 1,1], [])
